                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            ...
                            <div class="relative">
                                <img class="h-8 w-8 rounded-full object-cover ring-2 ring-gray-300 dark:ring-gray-500"
                                    src="{{ auth()->user()->avatar_url }}" alt="{{ auth()->user()->name }}">
                                <span
                                    class="absolute left-6 top-0 h-3 w-3 rounded-full border-2 border-white bg-green-400 dark:border-gray-800"></span>
                            </div>
